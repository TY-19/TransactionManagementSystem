...
{
    /// <summary>
    /// Parses a line in a specific format into a <see cref="TransactionDto"/> object.
    /// </summary>
    ...
    /// the line was parsed  successfully into a <see cref="TransactionDto"/> object (placed into Payload);
    /// false if the line cannot be parsed due to an incorrect number or format of values.
    /// </returns>
    Task<OperationResult<TransactionDto>> ParseLineAsync(string? csvLine, CancellationToken cancellationToken);
}
